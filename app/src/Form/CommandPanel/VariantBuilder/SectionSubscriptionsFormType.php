...
class SectionSubscriptionsFormType extends AbstractType
{
    public const ITEMS_AMOUNT = 3;

    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        /** @var SectionSubscriptionsFormDto $data */
        ...
        for ($i = 0; $i < $len; $i++) {
            ...
            $items
                ->add($key,
                    SubscriptionPlanFormType::class,
                    [
                        'label' => $label,
                        'required' => false,
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            'data_class' => SectionSubscriptionsFormDto::class,
        ]);
    }
}
